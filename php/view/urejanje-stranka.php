    ...
    <body>
        ...
        <div class="container">
            ...
            <?php if (isset($_SESSION['user_id'])):?>
                <form action="<?= BASE_URL . "urejanje-stranke" ?>" method="post">
                    ...
                    Naslov: <input type="text" name="naslov" value="<?= $podatki['naslov'] ?>"><br>
                    Telefon: <input type="text" name="telefon" value="<?= $podatki['telefon'] ?>"><br>
