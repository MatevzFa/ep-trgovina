                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <p><h3><?= $izdelek['cena'] ?> €</h3></p>
                            <p><?= $izdelek['opis'] ?></p>
                            <br>
                            <?php $percentOcena = isset($izdelek['povprecnaOcena']) ? $izdelek['povprecnaOcena'] : 0 ?>
                            Povprečna ocena izdelka: <?= isset($izdelek['povprecnaOcena']) ? $izdelek['povprecnaOcena'] : "Ni ocen" ?></p>
                            <div class="ocenaDIV">
                                    <div>
                                        <img style="max-width: 200px;" src="https://image.ibb.co/jpMUXa/stars_blank.png" alt="img">
                                    </div>
                                    <div class="ocenaSlika" style="width:<?=($percentOcena/5)*100 ?>%;">
                                        <img style="max-width: 200px;" src="https://image.ibb.co/caxgdF/stars_full.png" alt="">
                                    </div>
                             </div>
                            <br><br>
                            <div class="container">
                                <?php if ($jeOcenil == False): ?>
                                    ...
                                    <?php if (isset($_SESSION['user_id'])): ?>
                                        <form action="<?= BASE_URL . "oceni-izdelek" ?>" method="post">                                             
                                            ...
                                            <input type="submit" class="btn btn-primary" value="Oddaj oceno" />
